...
export class CreateEmployeeComponent extends Component {
    ...
    defineDate = () => {
        this.state.startDate = this.state.Year+"-"+this.state.Month+"-"+this.state.Day
    ...
    saveEmployee = (e) =>{
        this.defineDate();
        e.preventDefault();
        let employee = {name: this.state.name , gender: this.state.gender , departments: this.state.departments , imagePath:this.state.imagePath
        ,notes: this.state.note , startDate: this.state.startDate , salary: this.state.salary}
        console.log('employee => '+JSON .stringify(employee));

        EmployeeService.addEmployee(employee).then(res => {
            this.props.history.push("/");
        });
        // axios.post('http://localhost:8081/employee/add',this.state).then(response => {
    ...
    cancle(){
       ...
       this.props.history.push('/employees');
        // <Link to='/employees' class = "add-button">
        // </Link>
                 ...
                 <div className="form-content">
                    <form className="form" action="#" onreset="resetForm()" onSubmit={this.submitHandler}>
                        ...
                        <div className="row-content">
                            ...
                            <div>
                                <input type="radio" id="male" name="gender" value="male" onChange={this.changeHandler}/>
                                <label className="text" for="male">Male</label>
                                <input type="radio" id="female" name="gender" value="female" onChange={this.changeHandler}/>
                        ...
                        <div className="row-content">
                            ...
                            <div>
                                <input className="checkbox" type="checkbox" id="sales" name="department" value="Sales" onChange={this.changeDepartmentHandler}/>
                                <label className="text" for="sales">Sales</label>
                                <input className="checkbox" type="checkbox" id="finance" name="department" value="Finance" onChange={this.changeDepartmentHandler} />
                                <label className="text" for="finance">Finance</label>
                                <input className="checkbox" type="checkbox" id="engineer" name="department" value="Engineer" onChange={this.changeDepartmentHandler}/>
                                <label className="text" for="engineer">Engineer</label>
                                <input className="checkbox" type="checkbox" id="hr" name="department" value="HR" onChange={this.changeDepartmentHandler}/>
                                <label className="text" for="hr">HR</label>
                                <input className="checkbox" type="checkbox" id="others" name="department" value="Others" onChange={this.changeDepartmentHandler}/>
                        ...
                        <div className="row-content">
                            ...
                            <div id="date">
                                <select id="day" name="Day" onChange={this.changeHandler}>
                                ...
                                <select id="month" name="Month" onChange={this.changeHandler}>
                                ...
                                <select id="year" name="Year" onChange={this.changeHandler}>
                        ...
                        <div className="row-content">
                            ...
                            <textarea id="note" onChange={this.changeHandler} className="input" name="note" value={this.state.note} placeholder="add notes...."></textarea>
                        </div>
                        <div className="buttonParent">
                        <Link to='/employees' className="resetButton button cancelButton">cancel</Link>
                            <div className="submit-reset">
                                <button type="submit" className="button submitButton" id="submitButton" onClick={this.saveEmployee}>Submit</button>
                                <button type="reset" className="resetButton button" onClick={() => { this.props.history.push('/employees') }}>Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
